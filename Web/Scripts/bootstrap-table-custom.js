...
! function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s rows/page', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            ...
            if (totalRows == 0) {
                ...
                newPageFrom = pageFrom;
            }
            return sprintf('Displaying %s to %s of %s rows', newPageFrom, pageTo, totalRows);
        },
        ...
        this.$container = $([
            '<div class="bootstrap-table">',
                ...
                '<div class="fixed-table-body">',
                    ...
                    '</div>',
                '</div>',
                '<div class="fixed-table-footer"><table style="table-layout:fixed"><tr></tr></table></div>',
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('' +
                        '<input style="height:33px;" class="input-sm form-control ' + (this.options.iconSize === undefined ? '' : ' input-' + this.options.iconSize) + '" type="text" placeholder="%s" >',
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        var pageNumber = [
                ...
                ' <span class="caret"></span>',
                '</button>',
                '<ul class="dropdown-menu" role="menu" onChange="' + this.fixSideLeft() + '">'
        ],
		...
		*/
        ...
        if (this.totalPages == 0) {
            newTotalPages = parseInt(this.totalPages) + 1;
            newPageNumber = 1;
        } else {
            newTotalPages = this.totalPages;
            newPageNumber = this.options.pageNumber;
        }
        html.push(
			'<li class="page-number"><a style="padding:0.5px">&nbsp;&nbsp; Page : ' +
            '<input id="page" type="text" value="' + newPageNumber + '" min="1" max="' + this.totalPages + '">&nbsp; of ' + newTotalPages + ' &nbsp;&nbsp;</a></li>'
		);
        ...
        $number = this.$pagination.find('.page-number input');
        ...
        $number.off('keyup drop').on('keyup drop', function (event) {
    ...
    BootstrapTable.prototype.fixSideLeft = function () {
    ...
    BootstrapTable.prototype.onPageFirst = function (event) {
        this.options.pageNumber = 1;
        this.updatePagination(event);
//        $(".page-number input").val(this.options.pageNumber);
    };
...
//        $(".page-number input").val(this.options.pageNumber);
    ...
    BootstrapTable.prototype.resetFooter = function () {
        ...
        $.each(this.columns, function (i, column) {
            ...
            style = sprintf('vertical-align: %s; ', column.valign);
            width = sprintf('width: %s; ', column.width);

            html.push('<td', class_, sprintf(' style="%s"', falign + style + width), '>');
//            alert(column.width);
