...
$(function () {
    ...
    window.pis.table({
        objTable: $table,
        urlSearch: '/master/MasterGenericPage',
        urlPaging: '/master/MasterGenericPageXt',
        autoLoad: true
    });
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        $(".editRecord").attr('href', '/master/MasterGenericEdit/' + row.ID).trigger('click');
    },
...
function deleteThis(id) {
    $.ajax({
        type: "POST",
        url: myApp.root + 'Master/GroupIsActiveById',
