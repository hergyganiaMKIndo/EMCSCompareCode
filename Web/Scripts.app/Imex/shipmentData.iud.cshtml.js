window.operateManifest = {
	'click .edit': function (e, value, row, index) {
		loadModal('/vetting-process/ManifestEdit?isView=true&id=' + row.ShipmentManifestID)
	},
...
$(function () {
	...
	createTableShipmentManifest = function () {
		$tblShipmentManifest.bootstrapTable({
			...
			columns: [{
				...
				width: '180px',
				align: 'center',
				formatter: operateFormatter({ Edit: true}),
	...
	function operateFormatter(options) {
		...
		if (options.Edit == true)
			btn.push('<button type="button" class="btn btn-xs btn-info edit" title="view"><i class="fa fa-edit"></i></button>');
