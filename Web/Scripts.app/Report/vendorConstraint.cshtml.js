var $table = $('#tabelVendorConstraint');
...
$(function() {
        ...
        columns: [
            {
                ...
                field: 'vcon_PartsNumber',
                title: 'Parts Number',
                halign: 'center',
                align: 'left',
                sortable: true
            }, {
                field: 'vcon_Description',
                title: 'Description',
                halign: 'center',
                align: 'left',
                sortable: true
    ...
    $("#btnFilter").click(function() {
        ...
        window.pis.table({
            objTable: $table,
            urlSearch: '/report/VendorConstraintPage',
            urlPaging: '/report/VendorConstraintPageXt',
            searchParams: {
    ...
    $(".downloadExcel").click(function() {
        ...
        window.open("/Report/ExportToExcelVendorConstraint?" +
            "groupType=" + groupType +
            "&filterBy=" + filterBy +
