...
$(function () {
    ...
    $table.bootstrapTable({
        ...
        columns: [
        {
            ...
            field: 'strsp_Description',
            title: 'Description',
            halign: 'center',
            align: 'left',
            sortable: true
        }, {
            field: 'strsp_PackageQty',
            title: 'Package Qty',
            halign: 'center',
            align: 'left',
            sortable: true
            ...
            field: 'strsp_BOSubmissionDatetime',
            title: 'BO Submission Datetime',
            halign: 'center',
            align: 'left',
            sortable: true,
            formatter: 'dateFormatter'
        }, {
            field: 'strsp_PickupDate',
            title: 'Pickup Date',
            halign: 'center',
            align: 'left',
            sortable: true,
    ...
    $("#btnFilter").click(function () {
        ...
        window.pis.table({
            objTable: $table,
            urlSearch: '/report/STRespondTimePage',
            urlPaging: '/report/STRespondTimePageXt',
            searchParams: {
    ...
    $(".downloadExcel").click(function () {
        ...
        window.open("/Report/ExportToExcelSTRespondTimer?" +
           "groupType=" + groupType +
            "&filterBy=" + filterBy +
