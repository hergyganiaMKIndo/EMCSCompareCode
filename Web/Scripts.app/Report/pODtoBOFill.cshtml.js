...
$(function () {
    ...
    $table.bootstrapTable({
        ...
        columns: [
        {
            ...
            field: 'podbo_Description',
            title: 'Description',
            halign: 'center',
            align: 'left',
            sortable: true
        }, {
            field: 'podbo_PackageQty',
            title: 'Document Date',
            halign: 'center',
            align: 'left',
            sortable: true,
            ...
            field: 'podbo_SellingPrice',
            title: 'Selling Price',
            halign: 'center',
            align: 'left',
            sortable: true,
        }, {
            field: 'podbo_ReceiptDateTime',
            title: 'Receipt Date',
            halign: 'center',
            align: 'left',
    ...
    $("#btnFilter").click(function () {
        ...
        window.pis.table({
            objTable: $table,
            urlSearch: '/report/PODtoBOFillPage',
            urlPaging: '/report/PODtoBOFillPageXt',
            searchParams: {
    ...
    $(".downloadExcel").click(function () {
        ...
        window.open("/Report/ExportToExcelPodToFill?" +
          "groupType=" + groupType +
