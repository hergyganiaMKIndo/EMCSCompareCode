...
$(function () {
    ...
    $("#btnFilter").click(function () {
        ...
        window.pis.table({
            objTable: $table,
            urlSearch: '/report/PSSIntransitPage',
            urlPaging: '/report/PSSIntransitPageXt',
            searchParams: {
    ...
    $(".downloadExcel").click(function () {
        ...
        window.open("/Report/ExportToExcelPSSIntransit?" +
            "groupType=" + groupType +
            "&filterBy=" + filterBy +
