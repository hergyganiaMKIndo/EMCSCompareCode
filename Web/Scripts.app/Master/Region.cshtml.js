...
$(function () {
    ...
    window.pis.table({
        objTable: $table,
        urlSearch: '/master/RegionPage',
        urlPaging: '/master/RegionPageXt',
        autoLoad: true
    });
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        $(".editRecord").attr('href', '/master/RegionEdit/' + row.ID).trigger('click');
    },
...
function deleteThis(id) {
    $.ajax({
        type: "POST",
        url: myApp.root + 'Master/RegionIsActiveById',
