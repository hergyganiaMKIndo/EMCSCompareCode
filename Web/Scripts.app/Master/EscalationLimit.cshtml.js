...
$(function () {
    ...
    window.pis.table({
        objTable: $table,
        urlSearch: '/master/EscalationLimitPage',
        urlPaging: '/master/EscalationLimitPageXt',
        autoLoad: true
    });
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        $(".editRecord").attr('href', '/master/EscalationLimitEdit/' + row.ID).trigger('click');
    },
...
function deleteThis(id) {
    $.ajax({
        type: "POST",
        url: myApp.root + 'Master/EscalationLimitIsActiveById',
