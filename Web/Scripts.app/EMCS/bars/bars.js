...
function in_view(t) {
    var a = $(t),
        ...
        n = a.offset().top,
        o = n + a.height();
    console.log(a.attr("value"), a.parent().data("bg_max") * 100);
