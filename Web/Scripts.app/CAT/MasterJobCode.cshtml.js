...
$(function () {
    ...
    window.pis.table({
        objTable: $table,
        urlSearch: '/cat/MasterJobCodePage',
        urlPaging: '/cat/MasterJobCodePageXt',
        autoLoad: true
    });
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        $(".editRecord").attr('href', '/cat/MasterJobCodeEdit/' + row.ID).trigger('click');
    },
...
function deleteThis(id) {
    $.ajax({
        type: "POST",
        url: myApp.root + 'cat/MasterJobCodeDelete',
