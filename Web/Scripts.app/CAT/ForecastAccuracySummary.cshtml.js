...
$(function () {
    ...
    $table.bootstrapTable({
        ...
        columns: [
            ...
            { field: 'Sales', title: 'Sales', halign: 'center', align: 'center', sortable: true, switchable: false },
            ...
            { field: 'ForecastedSalesPercentage', title: 'Forecast Sales/Forecast (percentage)', halign: 'center', align: 'center', sortable: true },
    ...
    $('#btn-filter').click(function () {
        window.pis.table({
            objTable: $table,
            urlSearch: '/cat/ForecastAccuracySummaryPage',
            urlPaging: '/cat/ForecastAccuracySummaryPageXt',
            searchParams: {             
    ...
    $(".downloadExcel").click(function () {
        enableLink(false);
        $.ajax({
            url: "DownloadForecastAccuracySummary",
            type: 'GET',
            data: {
                customer_id: $('#customer_id').val(),
                store_id: $('#store_id').val(),
