...
$(function () {
    ...
    window.pis.table({
        objTable: $table,
        urlSearch: '/cat/MasterSOSPage',
        urlPaging: '/cat/MasterSOSPageXt',
        autoLoad: true
    });
...
window.operateEvents = {
    'click .edit': function (e, value, row, index) {
        $(".editRecord").attr('href', '/cat/MasterSOSEdit/' + row.ID).trigger('click');
    },
...
function deleteThis(id) {
    $.ajax({
        type: "POST",
        url: myApp.root + 'cat/MasterSOSDelete',
